...
// src/cli/commands/enable-statusline.ts
init_constants();
...
// src/cli/commands/enable-statusline.ts
async function handleEnableStatusline() {
  ...
  if (hasStatusLine && currentConfig) {
    console.log("Status line currently configured:");
    console.log("   Current: " + currentConfig.command);
    console.log("");
    if (!forceMode) {
      console.log("Zest status line will REPLACE your current configuration");
      console.log("");
